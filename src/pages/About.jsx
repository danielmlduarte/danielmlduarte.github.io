    ...
    <div>
      <div className="about-container">
        <div className="about-container-text">
          <h3>Sobre mim</h3>
          <h5>Eu sou o Daniel, um desenvolvedor front-end e estudante de desenvolvimento web full stack de BH, Minas Gerais.</h5>
          <p>
          Gosto de transformar problemas complexos em códigos simples, bonitos e intuitivos.
          Quando não estou codando, você me verá cozinhando, passeando na natureza ou praticando esportes ao ar livre.
          </p>
          <p>          
          Desde de pequeno, sempre muito curioso, me apaixonei por técnologia e pela computação, que pra mim, não só um trabalho, é um estilo de vida.
          </p>
